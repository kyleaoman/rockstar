...
\end{verbatim}      
      ...
      run.  (For that, see the next section, \ref{s:parallel_io}).
...
\end{verbatim}
      ...
      of files being read for each simulation snapshot:\footnote{If the number of blocks is more than the number of CPUs you wish to use, then you should also specify:
      	 \texttt{NUM\_READERS = $<$number of CPUs$>$}}
\begin{verbatim}
